...
bool vote(int voter, int rank, string name)
{
    // TODO -> for on candidates check name
    for (int i = 0; i < candidate_count; i++)
    {
...
void tabulate(void)
{
    // TODO -> with for check who has min votes and after that tabulate:)
    for (int i = 0; i < voter_count; i++)
    {
        int rank = 0;
        while (true)
...
int find_min(void)
{
    // TODO create a new variable for min and check candidates votes
